...
| [one.lisp](one.lisp) | Arithmetic | — | **Bug:** `E` is unbound; code is malformed |
| [fahr_to_cent.lisp](fahr_to_cent.lisp) | Arithmetic | `140` | **Bug:** formula is inverted — converts 60°C→°F, not 60°F→°C |
...
| [circle.lisp](circle.lisp) | Functions | — | **Bug:** `(defconstant PI ...)` conflicts with the built-in `pi`; use a different name |
